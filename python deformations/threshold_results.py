...
#				mlfd.sum_of_dists, mlfd.curvature_comparison]
#
...
#                'PCM', 'Area', 'DTW2', 'Curve_Length2', 'sum_of_dists', 'curvature_comparison']
    ...
    for i in range (len(lasa_names)):
        for j in range(len(metric_names)):
            ...
            try:
                ...
                print ("Creation of the directory %s failed" % new_fpath)
            else:
                print ("Successfully created the directory %s" % new_fpath)
            ...
            my_mlfd.read_from_h5(old_fpath + metric_name + '_' + lasa_names[i] + '.h5')
            ...
            my_mlfd.plot_strongest_gradients_thresholded(mode='save', filepath=new_fpath)
