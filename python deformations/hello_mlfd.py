...
def main():
    ...
    plt_fpath = 'FOR_PAPER/Frechet_hello_new_DMP_tuned/'
    try:
    ...
    #my_mlfd.reproduce_at_point(np.array([[x_data[0][0], y_data[0][0]]]), plot=True)
    ...
    #my_mlfd.reproduce_optimal_at_point(np.array([[x_data[0][0] - offset / 2, y_data[0][0] - offset]]), plot=True, mode='save', filepath=plt_fpath)
    #my_mlfd.svm_region_contour(mode='save', filepath=plt_fpath, plot_point=[x_data[0][0] - offset / 2, y_data[0][0] - offset])
