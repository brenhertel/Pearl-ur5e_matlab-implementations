...
[dmp_fd_mat, lte_fd_mat, ja_fd_mat] = normalized3(dmp_fd, lte_fd, ja_fd);
[dmp_hd_mat, lte_hd_mat, ja_hd_mat] = normalized3(dmp_hd, lte_hd, ja_hd);
% [lte_hd_mat, ja_hd_mat] = normalized2(lte_hd, ja_hd);
% [lte_fd_mat, ja_fd_mat] = normalized2(lte_fd, ja_fd);
...
title('DMP FD lowess Surface', 'FontSize', 28);
figure;
...
title('DMP HD lowess Surface', 'FontSize', 28);
figure;
...
title('LTE FD lowess Surface', 'FontSize', 28);
figure;
...
title('LTE HD lowess Surface', 'FontSize', 28);
figure;
...
title('JA FD lowess Surface', 'FontSize', 28);
figure;
...
title('JA HD lowess Surface', 'FontSize', 28);

graph_gradient_simple(grid_size, dmp_fd_mat, dmp_hd_mat, 'DMP')
graph_gradient_simple(grid_size, ja_fd_mat, ja_hd_mat, 'JA')
graph_gradient_simple(grid_size, lte_fd_mat, lte_hd_mat, 'LTE')

% graph_diff2(grid_size, lte_fd_mat, ja_fd_mat, 'Frechet');
% graph_diff2(grid_size, lte_hd_mat, ja_hd_mat, 'Haussdorf');
graph_diff3(grid_size, lte_hd_mat, ja_hd_mat, dmp_hd_mat, 'Haussdorf');
graph_diff3(grid_size, lte_fd_mat, ja_fd_mat, dmp_fd_mat, 'Frechet');
